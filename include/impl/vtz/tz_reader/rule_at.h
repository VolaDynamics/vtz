...
namespace vtz {
    ...
    class rule_at {
      ...
      public:
        ...
        constexpr sys_seconds_t resolve_at( sys_days_t date,
            from_utc                                   stdoff,
            from_utc walloff ) const noexcept {
        ...
        constexpr sys_seconds_t resolve_at(
            sys_days_t date, zone_time time ) const noexcept {
    ...
    using opt_rule_at = opt_class<rule_at>;
